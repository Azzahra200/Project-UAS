...
if($_POST){
	...
	if(empty($nama_jurusan)){
		...
		include "koneksi.php";
		$insert=mysqli_query($conn,"insert into ambil_jurusan (nama_jurusan, angkatan) value ('".$nama_jurusan."','".$angkatan."')");
		if($insert){
			echo "<script>alert('Sukses menambahkan jurusan');location.href='tampil_jurusan.php';</script>";
		} else {
